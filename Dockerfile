...
ENV DOMAIN_NAME=myinfraDomain ADMIN_NAME=myadmin ADMIN_HOST=InfraAdminContainer ADMIN_LISTEN_PORT=7001 MANAGEDSERVER_PORT=8001 MANAGED_NAME=infraServer1 ADMINISTRATION_PORT_ENABLED=true ADMINISTRATION_PORT=9002 RCUPREFIX=INFRA01 PRODUCTION_MODE=dev CONNECTION_STRING=myoracledb2.cgqwbwooqm3q.us-west-2.rds.amazonaws.com:1521/ORAC
